...
sprites.onOverlap(SpriteKind.Player, SpriteKind.soon, function on_on_overlap(sprite4: Sprite, otherSprite3: Sprite) {
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function on_a_pressed() {
    ...
    if (game2 == 1) {
        if (tiles.tileAtLocationEquals(tiles.getTileLocation(grid.spriteCol(mySprite), grid.spriteRow(mySprite)), assets.tile`
                myTile5
            `)) {
            if (info.score() >= 100) {
...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Plants, function on_on_overlap2(sprite: Sprite, otherSprite: Sprite) {
...
scene.onOverlapTile(SpriteKind.Enemy, assets.tile`
        myTile6
    `, function on_overlap_tile(sprite5: Sprite, location2: tiles.Location) {
    game.over(false)
})
function wave1() {
...
scene.onOverlapTile(SpriteKind.Enemy, assets.tile`
        myTile3
    `, function on_overlap_tile2(sprite2: Sprite, location: tiles.Location) {
    game.over(false)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function on_on_overlap3(sprite8: Sprite, otherSprite5: Sprite) {
...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.shooter, function on_on_overlap4(sprite3: Sprite, otherSprite2: Sprite) {
...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.wall, function on_on_overlap5(sprite6: Sprite, otherSprite4: Sprite) {
...
game.onUpdateInterval(15000, function on_update_interval() {
    
    for (let value of sprites.allOfKind(SpriteKind.Plants)) {
        animation.runImageAnimation(value, [img`
                    . . . f f f . f f f f . . . . . 
                                . . f 1 1 1 f 1 1 1 1 f . . . . 
...
game.onUpdateInterval(20000, function on_update_interval3() {
...
game.onUpdateInterval(10000, function on_update_interval4() {
    if (wave == 1) {
        wave1()
    }
